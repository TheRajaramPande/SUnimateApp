...
class SearchViewModel : ViewModel() {
    ...
    fun getPosts(city: String? = null) {
        val query = if (city.isNullOrEmpty()) {
            database.collection("HomePosts")
        } else {
            database.collection("HomePosts").whereEqualTo("home.address.city", city)
        }
...
//    fun getPosts(city: String? = "Syracuse") {
//        database.collection("HomePosts")
