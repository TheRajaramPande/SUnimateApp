...
import com.example.finalproject.databinding.ItemHomePostBinding
                        ...
                        if (documents.isEmpty) {
                            database.collection("Profiles")
                                ...
                                .addOnSuccessListener {
                                    binding.favoriteBtn.setImageResource(com.example.finalproject.R.drawable.round_favorite_24)
                                }
                        } else {
                            database.collection("Profiles")
                                .document(uid)
                                ...
                                .delete()
                                .addOnSuccessListener {
                                    binding.favoriteBtn.setImageResource(com.example.finalproject.R.drawable.round_favorite_border_24)
                                }
                        }
                    }
            }
